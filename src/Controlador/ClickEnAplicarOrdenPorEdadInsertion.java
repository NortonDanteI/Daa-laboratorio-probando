...
public class ClickEnAplicarOrdenPorEdadInsertion implements ActionListener{
		JTextArea textocambio3; JTextArea textocambio4; ArrayList<Alumno> listax2;
		
		public ClickEnAplicarOrdenPorEdadInsertion(JTextArea textocambio1, JTextArea textocambio2, ArrayList<Alumno> listax1){
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			textocambio4.append("Ordenando por edad mediante Insertion Sort\n");
			
			InsertionSort.ordenarListaEdad(listax2,textocambio4);
			textocambio3.append("----------------------------------------------------------------------------------------\n");
