...
public class ClickEnAplicarOrdenPorNombre implements ActionListener{
	JTextArea textocambio1;
	JTextArea textocambio2;
	ArrayList<Alumno> listax1;
	OrdenaCollections ordena = new OrdenaCollections();
	
	public ClickEnAplicarOrdenPorNombre(ArrayList<Alumno> lista, JTextArea areaDeTexto1, JTextArea areaDeTexto){
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		listax1=ordena.ordenaAlumnoNombre(listax1,textocambio2);
		textocambio1.append("----------------------------------------------------------------------------------------------------------\n");
