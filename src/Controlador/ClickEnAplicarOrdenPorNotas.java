...
public class ClickEnAplicarOrdenPorNotas implements ActionListener{
	JTextArea textocambio1;
	JTextArea textocambio2;
	ArrayList<Alumno> listax1;
	OrdenaCollections ordena = new OrdenaCollections();
	
	public ClickEnAplicarOrdenPorNotas(ArrayList<Alumno> lista, JTextArea areaDeTexto1, JTextArea areaDeTexto){
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		listax1=ordena.ordenaAlumnoNotas(listax1,textocambio2);
		textocambio1.append("----------------------------------------------------------------------------------------------------------\n");
