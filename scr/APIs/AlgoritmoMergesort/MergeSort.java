...
public final class MergeSort {
	...
	public static void porNombre(ArrayList<Alumno> lista, int inicio, int fin) {
		if(inicio < fin) {
			int medio = (inicio + fin) / 2;
			porNombre(lista, inicio, medio);
			porNombre(lista, medio + 1, fin);
			mezclar(lista, inicio, medio, fin, 0);
		}
